(function ($) {
    ...
    $(function () {
        ...
        uploader = WebUploader.create({
            pick: '#addImages',// 选择文件的按钮。可选。
            auto: true,// 选完文件后，是否自动上传。
            swf: './Uploader.swf',
            chunked: false,
            chunkSize: 512 * 1024,
            server: '/ImageUpload/GetImage',
            // runtimeOrder: 'flash',
        ...
        //uploader = WebUploader.create({
        //    pick: '#personalUpload',// 选择文件的按钮。可选。
        //    auto: true,// 选完文件后，是否自动上传。
        //    swf: './Uploader.swf',
        //    chunked: false,
        //    chunkSize: 512 * 1024,
        ...
        uploader.on('uploadError', function (file) {
            alert("文件 "+result.filename+" 上传失败" + result.error);
        });
        uploader.on('uploadFinished', function () {
            ...
            var email = $('#EMail').val() ;
            if (email != "") {
                var totalEmail=email+ "@philips.com";
                GetPhoto(totalEmail);
            }
            uploader.reset();
        });
